...
export default function Home() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center bg-[#FAF7F2] dark:bg-slate-950">
        <BlobDecoration
          variant={1}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-[#E8F0E9] dark:bg-emerald-900/30 text-[#5A7A60] dark:text-emerald-400 text-sm font-medium">
                <span className="flex h-2 w-2 rounded-full bg-[#7C9A82] dark:bg-emerald-400 mr-2" />
                Mental Wellness for Everyone
              </div>

              <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold text-[#2D3436] dark:text-white leading-tight">
                Your compassionate companion on the <br />
                journey to mental wellness.
              </h1>

              <p className="text-lg md:text-xl text-[#5A6062] dark:text-slate-300 max-w-lg leading-relaxed font-sans">
              ...
              <div className="pt-8 flex items-center gap-8 text-sm text-[#5A6062] dark:text-slate-400">
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-5 w-5 text-[#7C9A82] dark:text-emerald-400" />
              ...
              <Card className="p-5 bg-[#FFFDF9] dark:bg-slate-800 border border-[#E8F0E9] dark:border-slate-700 max-w-xl">
                <h3 className="font-serif text-xl font-bold text-[#2D3436] dark:text-white mb-2">
                  Our Goal
                </h3>
                <p className="text-[#5A6062] dark:text-slate-300">
      ...
      <section id="learn-explore" className="py-20 bg-white dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <h2 className="font-serif text-4xl font-bold text-[#2D3436] dark:text-white mb-4">
              Learn & Explore
            </h2>
            <p className="text-[#5A6062] dark:text-slate-400 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="p-8 hover:bg-[#FAF7F2] dark:hover:bg-slate-800 transition-colors border-none shadow-lg">
              <h3 className="font-serif text-2xl font-bold text-[#2D3436] dark:text-white mb-3">
                About SwasthyaManas
              </h3>
              <p className="text-[#5A6062] dark:text-slate-300 leading-relaxed mb-6">
                SwasthyaManas is a mental health support platform.
              </p>
              <div className="inline-flex items-center text-xs font-medium px-3 py-1 rounded-full bg-[#E8F0E9] dark:bg-emerald-900/30 text-[#5A7A60] dark:text-emerald-400">
                about
              </div>
            </Card>
            ...
            <Card className="p-8 hover:bg-[#FAF7F2] dark:hover:bg-slate-800 transition-colors border-none shadow-lg">
              ...
              <Link
                to="/assessments"
                className="text-[#7C9A82] dark:text-emerald-400 font-medium flex items-center hover:underline"
              >
      ...
      <section className="py-24 bg-white dark:bg-slate-900 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="p-8 hover:bg-[#FAF7F2] dark:hover:bg-slate-800 transition-colors border-none shadow-lg">
              <div className="w-14 h-14 bg-[#E8F0E9] dark:bg-emerald-900/30 rounded-2xl flex items-center justify-center mb-6">
                <Shield className="h-7 w-7 text-[#7C9A82] dark:text-emerald-400" />
              </div>
              <h3 className="font-serif text-2xl font-bold text-[#2D3436] dark:text-white mb-3">
                Self Assessments
              </h3>
            ...
            <Card className="p-8 hover:bg-[#FAF7F2] dark:hover:bg-slate-800 transition-colors border-none shadow-lg">
              <div className="w-14 h-14 bg-[#E8F0E9] dark:bg-emerald-900/30 rounded-2xl flex items-center justify-center mb-6">
                <Users className="h-7 w-7 text-[#7C9A82] dark:text-emerald-400" />
              </div>
              <h3 className="font-serif text-2xl font-bold text-[#2D3436] dark:text-white mb-3">
                Expert Support
              </h3>
            ...
            <Card className="p-8 hover:bg-[#FAF7F2] dark:hover:bg-slate-800 transition-colors border-none shadow-lg">
              <div className="w-14 h-14 bg-[#E8F0E9] dark:bg-emerald-900/30 rounded-2xl flex items-center justify-center mb-6">
                <Brain className="h-7 w-7 text-[#7C9A82] dark:text-emerald-400" />
              </div>
              <h3 className="font-serif text-2xl font-bold text-[#2D3436] dark:text-white mb-3">
                Progress Tracking
              </h3>
